...
Singleton {
    ...
    m3colors: QtObject {
        ...
        // #373b3e (55,59,62) - Background
        // #bec8d1 (190,200,209) - Foreground  
        // #86cecb (134,206,203) - Accent/Turquoise
        // #137a7f (19,122,127) - Secondary/Deep Blue
        // #e12885 (225,40,133) - Special/Pink
        property color m3primary_paletteKeyColor: "#86cecb"
        property color m3secondary_paletteKeyColor: "#137a7f"
        property color m3tertiary_paletteKeyColor: "#e12885"
        property color m3neutral_paletteKeyColor: "#373b3e"
        property color m3neutral_variant_paletteKeyColor: "#373b3e"
        property color m3background: "#373b3e"
        property color m3onBackground: "#bec8d1"
        property color m3surface: "#373b3e"
        property color m3surfaceDim: "#2a2e31"
        property color m3surfaceBright: "#4a4e51"
        property color m3surfaceContainerLowest: "#1e2225"
        property color m3surfaceContainerLow: "#2a2e31"
        property color m3surfaceContainer: "#373b3e"
        property color m3surfaceContainerHigh: "#4a4e51"
        property color m3surfaceContainerHighest: "#5a5f63"
        property color m3onSurface: "#bec8d1"
        property color m3surfaceVariant: "#4a4e51"
        property color m3onSurfaceVariant: "#bec8d1"
        property color m3inverseSurface: "#bec8d1"
        property color m3inverseOnSurface: "#373b3e"
        property color m3outline: "#86cecb"
        property color m3outlineVariant: "#4a4e51"
        property color m3shadow: "#000000"
        property color m3scrim: "#000000"
        property color m3surfaceTint: "#86cecb"
        property color m3primary: "#86cecb"
        property color m3onPrimary: "#373b3e"
        property color m3primaryContainer: "#137a7f"
        property color m3onPrimaryContainer: "#bec8d1"
        property color m3inversePrimary: "#86cecb"
        property color m3secondary: "#137a7f"
        property color m3onSecondary: "#bec8d1"
        property color m3secondaryContainer: "#0f5a5f"
        property color m3onSecondaryContainer: "#86cecb"
        property color m3tertiary: "#e12885"
        property color m3onTertiary: "#bec8d1"
        property color m3tertiaryContainer: "#a01d5f"
        property color m3onTertiaryContainer: "#bec8d1"
        property color m3error: "#e12885"
        property color m3onError: "#bec8d1"
        property color m3errorContainer: "#a01d5f"
        property color m3onErrorContainer: "#bec8d1"
        property color m3primaryFixed: "#86cecb"
        property color m3primaryFixedDim: "#86cecb"
        property color m3onPrimaryFixed: "#373b3e"
        property color m3onPrimaryFixedVariant: "#137a7f"
        property color m3secondaryFixed: "#137a7f"
        property color m3secondaryFixedDim: "#137a7f"
        property color m3onSecondaryFixed: "#bec8d1"
        property color m3onSecondaryFixedVariant: "#0f5a5f"
        property color m3tertiaryFixed: "#e12885"
        property color m3tertiaryFixedDim: "#e12885"
        property color m3onTertiaryFixed: "#bec8d1"
        property color m3onTertiaryFixedVariant: "#a01d5f"
        property color m3success: "#86cecb"
        property color m3onSuccess: "#373b3e"
        property color m3successContainer: "#137a7f"
        property color m3onSuccessContainer: "#bec8d1"
        // Terminal colors based on Hatsune Miku palette
        property color term0: "#373b3e"
        property color term1: "#e12885"
        property color term2: "#86cecb"
        property color term3: "#bec8d1"
        property color term4: "#137a7f"
        property color term5: "#e12885"
        property color term6: "#86cecb"
        property color term7: "#bec8d1"
        property color term8: "#5a5f63"
        property color term9: "#ff4da3"
        property color term10: "#a8e6e3"
        property color term11: "#d4e0e7"
        property color term12: "#1a9ba1"
        property color term13: "#ff4da3"
        property color term14: "#a8e6e3"
        property color term15: "#d4e0e7"
    }
